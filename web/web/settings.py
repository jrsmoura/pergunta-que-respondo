"""
Configurações do Django para o projeto web.
...
SECRET_KEY = "django-insecure-iu)eqhiam3(l)ovh21vh#wpsk!ax!b+dvbuk++r_mw$+8-4*$-"
...
INSTALLED_APPS = [
    ...
    "chatbot"  # Nome da pasta onde está o nosso app
]
